...
public class SplunkBatchSinkConfig extends BaseSplunkConfig {
  ...
  /**
   * Constructor for SplunkBatchSinkConfig object.
   ...
   * @param channelIdentifierHeader the channel identifier header
   */
  ...
  /**
   * Verify the fields of schema and properties of failureCollector.
