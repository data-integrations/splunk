...
public class SplunkSearchClient {
  ...
  public List<Map<String, String>> getSample() throws IOException {
    // TODO why 100 and not any other numer? https://issues.cask.co/browse/PLUGIN-363
  ...
  private String getSearchId(SplunkSourceConfig config, Long countOfRecords) {
    ...
    while (!job.isDone()) {
      ...
      /* TODO: explain why we return here if seach mode is SEARCH_REALTIME or countOfRecords <= job.getResultCount()
       * https://issues.cask.co/browse/PLUGIN-362
       */
