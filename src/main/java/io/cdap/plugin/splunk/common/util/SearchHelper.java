...
public class SearchHelper {
  ...
  /**
   * Returns the string.
   * @param config the splunk source config
   * @return string
   */
  ...
  /**
   * Returns the type of the value being retryered.
   * @param config the basesplunkconfig
   * @param <T> the type of the value
   * @return type of the value being retryered
   */
